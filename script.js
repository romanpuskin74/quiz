...
let container_h3 = document.querySelector('.container_h3')
 ...
 let cotaniner_start= document.querySelector(".start")
 let container_main = document.querySelector('.main')
 let start_butten = document.querySelector('.start-btb')
...
start_butten.addEventListener("click",function(){
   cotaniner_start.style.display = 'none' 
   ...
   cotaniner_start.style.display = 'flex' 
